		...
		<div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-12 sm:px-6 lg:px-8">
			<div className="w-full max-w-md space-y-8 rounded-xl bg-white p-8 shadow-sm">
				<div className="flex justify-end">
					<Link to="/staff/login" className="text-xs font-semibold text-indigo-600 hover:text-indigo-500 bg-indigo-50 px-3 py-1.5 rounded-full transition-colors border border-indigo-100 flex items-center gap-1.5">
