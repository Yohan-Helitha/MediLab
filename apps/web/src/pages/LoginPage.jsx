...
const userWithRole = { ...response.data.user, userType: "patient" };
...
{error && (
<div className="p-3 rounded-xl bg-rose-50 border border-rose-100 flex items-center gap-3 animate-in fade-in slide-in-from-top-1">
